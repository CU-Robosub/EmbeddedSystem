...
void adcConfigure(void)
{
    ...
    ADC14->CTL0     |= ADC14_CTL0_SHT0__128 | ADC14_CTL0_SHT1__128 |  // 128 clock cycle sample-and-hold times
                       ...
                       ADC14_CTL0_PDIV__32;                           // Divide MODCLK by 32 for ADCCLK
    ...
    ADC14->MCTL[0]  |= ADC14_MCTLN_INCH_0 | ADC14_MCTLN_VRSEL_1;                      // Motor 1
    ADC14->MCTL[1]  |= ADC14_MCTLN_INCH_1 | ADC14_MCTLN_VRSEL_1;                      // Motor 2
    ADC14->MCTL[2]  |= ADC14_MCTLN_INCH_2 | ADC14_MCTLN_VRSEL_1;                      // Motor 3
    ADC14->MCTL[3]  |= ADC14_MCTLN_INCH_3 | ADC14_MCTLN_VRSEL_1;                      // Motor 4
    ADC14->MCTL[4]  |= ADC14_MCTLN_INCH_4 | ADC14_MCTLN_VRSEL_1;                      // Motor 5
    ADC14->MCTL[5]  |= ADC14_MCTLN_INCH_5 | ADC14_MCTLN_VRSEL_1;                      // Motor 6
    ADC14->MCTL[6]  |= ADC14_MCTLN_INCH_6 | ADC14_MCTLN_VRSEL_1;                      // Motor 7
    ADC14->MCTL[7]  |= ADC14_MCTLN_INCH_7 | ADC14_MCTLN_VRSEL_1 | ADC14_MCTLN_EOS;    // Motor 8 (End of motor conversion sequence)
    ADC14->MCTL[8]  |= ADC14_MCTLN_INCH_8 | ADC14_MCTLN_VRSEL_1;                      // 3.3V or 5V current
    ADC14->MCTL[9]  |= ADC14_MCTLN_INCH_9 | ADC14_MCTLN_VRSEL_1;                      // 9V current
    ADC14->MCTL[10] |= ADC14_MCTLN_INCH_10 | ADC14_MCTLN_VRSEL_1;                     // 12V current
    ADC14->MCTL[11] |= ADC14_MCTLN_INCH_11 | ADC14_MCTLN_VRSEL_1;                     // 19V current
    ADC14->MCTL[12] |= ADC14_MCTLN_INCH_12 | ADC14_MCTLN_VRSEL_1;                     // 48V current
    ADC14->MCTL[13] |= ADC14_MCTLN_INCH_13 | ADC14_MCTLN_VRSEL_1 | ADC14_MCTLN_EOS;   // Battery voltage (End of power status conversion sequence)
